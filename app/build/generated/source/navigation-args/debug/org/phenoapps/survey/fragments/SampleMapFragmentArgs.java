...
public class SampleMapFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private SampleMapFragmentArgs() {
  }

  private SampleMapFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static SampleMapFragmentArgs fromBundle(@NonNull Bundle bundle) {
    SampleMapFragmentArgs __result = new SampleMapFragmentArgs();
    bundle.setClassLoader(SampleMapFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    SampleMapFragmentArgs that = (SampleMapFragmentArgs) object;
  ...
  public static class Builder {
    ...
    public Builder(SampleMapFragmentArgs original) {
    ...
    @NonNull
    public SampleMapFragmentArgs build() {
      SampleMapFragmentArgs result = new SampleMapFragmentArgs(arguments);
      return result;
    }
